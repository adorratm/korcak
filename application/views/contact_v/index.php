                                ...
                                <div class="lower-content">
                                    ...
                                    <ul>
                                        ...
                                        <?php if (!empty($whatsapps[$key])) : ?>
                                            <li class="d-none"><a href="https://api.whatsapp.com/send?phone=<?= @str_replace(" ", "", @$whatsapps[$key]) ?>&amp;text=<?= urlencode(lang("hello") . " " . $settings->company_name) ?>."><i class="fa fa-whatsapp"></i> <span><?= @$whatsapps[$key] ?></span></a></li>
                                        <?php endif ?>
                    ...
                    <div class="contact-form">
                        <form onsubmit="return false" enctype="multipart/form-data" method="POST" id="contact-form">
                            <div class="row">
                                ...
                                <?php $securityPolicy = $this->general_model->get("pages", null, ["isActive" => 1, "id" => 9, "lang" => $this->viewData->lang]) ?>
                                <?php empty($securityPolicy) ? $securityPolicy = $this->general_model->get("pages", null, ["isActive" => 1, "id" => 21, "lang" => $this->viewData->lang]) : null ?>
                                <?php $kvkk = $this->general_model->get("pages", null, ["isActive" => 1, "id" => 12, "lang" => $this->viewData->lang]) ?>
                                <?php empty($kvkk) ? $kvkk = $this->general_model->get("pages", null, ["isActive" => 1, "id" => 24, "lang" => $this->viewData->lang]) : null ?>
