                    ...
                    <?php if (strtotime($value->sharedAt) <= strtotime("now")) : ?>
                        <div class="col-lg-4 col-md-6 service-block">
                            <div class="inner-box h-100">
                                <a class="image d-block" rel="dofollow" href="<?= base_url(lang("routes_galleries"). "/{$value->url}") ?>" title="<?= $value->title ?>">
                                ...
                                <div class="lower-content">
                                    <h4><a rel="dofollow" href="<?= base_url(lang("routes_galleries") . "/{$value->url}") ?>" title="<?= $value->title ?>"><?= $value->title ?></a></h4>
                                    <div class="link"><a rel="dofollow" href="<?= base_url(lang("routes_galleries") . "/{$value->url}") ?>" title="<?= $value->title ?>" class="link-btn"><i class="text-white fa fa-arrow-right"></i> </a></div>
                                </div>
                            </div>
                        </div>
                    <?php endif ?>
