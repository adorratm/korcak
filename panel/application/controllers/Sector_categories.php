...
class Sector_categories extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $viewData->items = $this->sector_category_model->get_all(["lang" => $this->session->userdata('activeLang')]);
        $this->load->view("{$viewData->viewFolder}/{$viewData->subViewFolder}/index", $viewData);
    }
    public function datatable()
    {
        $items = $this->sector_category_model->getRows(["lang" => $this->session->userdata('activeLang')], $_POST);
        $data = [];
        ...
        $output = [
            ...
            "recordsTotal" => $this->sector_category_model->rowCount(["lang" => $this->session->userdata('activeLang')]),
            "recordsFiltered" => $this->sector_category_model->countFiltered(["lang" => $this->session->userdata('activeLang')], (!empty($_POST) ? $_POST : [])),
            "data" => $data,
        ];
    ...
    {
        $viewData = new stdClass();
        $viewData->categories = $this->sector_category_model->get_all(["lang" => $this->session->userdata('activeLang')]);
        $viewData->viewFolder = $this->viewFolder;
    ...
    public function save()
    {
        ...
        if (checkEmpty($data)["error"]) :
            ...
            $getRank = $this->sector_category_model->rowCount(["lang" => $this->session->userdata('activeLang')]);
    ...
    public function delete($id)
    {
        ...
        if (!empty($sector_category)) :
            ...
            if ($delete) :
                 ...
                 */
                $sectors = $this->sector_model->get_all(["lang" => $this->session->userdata('activeLang')]);
                if (!empty($sectors)) :
