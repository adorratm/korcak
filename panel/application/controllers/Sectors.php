...
class Sectors extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $viewData->items = $this->sector_model->get_all(["lang" => $this->session->userdata('activeLang')], "rank ASC");
        $this->load->view("{$this->viewFolder}/{$viewData->subViewFolder}/index", $viewData);
    }
    public function datatable()
    {
        $items = $this->sector_model->getRows(["lang" => $this->session->userdata('activeLang')], $_POST);
        $data = [];
        ...
        $output = [
            ...
            "recordsTotal" => $this->sector_model->rowCount(["lang" => $this->session->userdata('activeLang')]),
            "recordsFiltered" => $this->sector_model->countFiltered(["lang" => $this->session->userdata('activeLang')], (!empty($_POST) ? $_POST : [])),
            "data" => $data,
        ];
    ...
    public function save()
    {
        ...
        if (checkEmpty($data)["error"] && checkEmpty($data)["key"] != "content") :
            ...
            $getRank = $this->sector_model->rowCount(["lang" => $this->session->userdata('activeLang')]);
            if (!empty($_FILES)) :
