    ...
    public function delete($id)
    {
        ...
        if (!empty($settings)) :
            ...
            if ($delete) :
                ...
                if (!is_dir(FCPATH . "uploads/{$this->viewFolder}/{$settings->contact_logo}") && file_exists(FCPATH . "uploads/{$this->viewFolder}/{$settings->contact_logo}")) :
                    unlink(FCPATH . "uploads/{$this->viewFolder}/{$settings->contact_logo}");
                endif;
                ...
                if (!is_dir(FCPATH . "uploads/{$this->viewFolder}/{$settings->gallery_logo}") && file_exists(FCPATH . "uploads/{$this->viewFolder}/{$settings->gallery_logo}")) :
                    unlink(FCPATH . "uploads/{$this->viewFolder}/{$settings->gallery_logo}");
                endif;
                if (!is_dir(FCPATH . "uploads/{$this->viewFolder}/{$settings->product_logo}") && file_exists(FCPATH . "uploads/{$this->viewFolder}/{$settings->product_logo}")) :
                    unlink(FCPATH . "uploads/{$this->viewFolder}/{$settings->product_logo}");
                endif;
