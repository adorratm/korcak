...
class Technical_information_categories extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $items = $this->technical_information_category_model->get_all(["technical_information_categories.lang" => $this->session->userdata('activeLang')]);
    ...
    {
        $items = $this->technical_information_category_model->getRows(["technical_information_categories.lang" => $this->session->userdata('activeLang')], $_POST);
        $data = [];
        ...
        $output = [
            ...
            "recordsTotal" => $this->technical_information_category_model->rowCount(["technical_information_categories.lang" => $this->session->userdata('activeLang')]),
            "recordsFiltered" => $this->technical_information_category_model->countFiltered(["technical_information_categories.lang" => $this->session->userdata('activeLang')], (!empty($_POST) ? $_POST : [])),
            "data" => $data,
        ];
    ...
    public function save()
    {
        ...
        if (checkEmpty($data)["error"] && checkEmpty($data)["key"] != "top_id") :
            ...
            $getRank = $this->technical_information_category_model->rowCount(["lang" => $this->session->userdata('activeLang')]);
            if (!empty($_FILES)) :
    ...
    public function update_form($id)
    {
        ...
        $category = $this->technical_information_category_model->get_all(["id!=" => $viewData->item->id, "lang" => $this->session->userdata('activeLang')]);
